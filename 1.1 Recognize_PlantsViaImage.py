...
api_key = 'api-key=2a10qZqW65kImRBwZrqaEFYhe' #We need to pass our API-Key along with the url which can be found in the plantnet account settings after loging in
